...
const PricingOptions: FC<PricingOptionProps> = ({title, description, price, priceDescription, features}) => {
  return (
    <div className="flex flex-col p-6 mx-auto max-w-lg text-center dark:text-white text-gray-900  rounded-lg border border-gray-100 shadow">
      ...
      <div className="flex justify-center items-baseline my-8">
        ...
        <span className="text-gray-500 dark:text-gray-400">{priceDescription}</span>
      </div>
